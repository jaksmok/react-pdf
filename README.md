<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@jakmsok-react-pdf/renderer">
      <img src="https://img.shields.io/npm/v/@jakmsok-react-pdf/renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @jakmsok-react-pdf/renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@jakmsok-react-pdf/renderer';
...
import { PDFViewer } from '@jakmsok-react-pdf/renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@jakmsok-react-pdf/renderer';
...
---
![](https://img.shields.io/npm/dt/@jakmsok-react-pdf/renderer.svg?style=flat)
