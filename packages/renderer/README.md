<p align="center">
  ...
  <p align="center">
    <a href="https://www.npmjs.com/package/@jaksmok-react-pdf/renderer">
      <img src="https://img.shields.io/npm/v/@jaksmok-react-pdf/renderer.svg" />
    </a>
...
## How to install
```sh
yarn add @jaksmok-react-pdf/renderer
```
...
import { Document, Page, Text, View, StyleSheet } from '@jaksmok-react-pdf/renderer';
...
import { PDFViewer } from '@jaksmok-react-pdf/renderer';
...
```jsx
import React from 'react';
import ReactPDF from '@jaksmok-react-pdf/renderer';
...
---
![](https://img.shields.io/npm/dt/@jaksmok-react-pdf/renderer.svg?style=flat)
